...
export class FakeApiClient implements IApiClient {
  ...
  readonly commands: IApiClient['commands'] = {
    list: payload => this.record('command.list', payload, Promise.resolve(ok({ commands: [] }))),
    execute: payload => this.record('command.execute', payload, Promise.resolve(ok({ matched: false as const }))),
  }

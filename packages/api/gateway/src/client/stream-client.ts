...
import { readSessionToken, resolveBrowserConnectionOrigin } from '@deepseek-ai/dsh-client-connection/client'
...
function remoteStreamUrl(): string {
  const url = new URL(REMOTE_STREAM_MUX_PATH, resolveBrowserConnectionOrigin())
